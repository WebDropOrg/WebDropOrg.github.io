...
export const showcaseProjects: ProjectConfig[] = [
  {
    ...
    url: "https://midday.ai/",
    description: "Professional business website with modern design and optimized performance for a technology company.",
  ...
  },
  {
    ...
    description: "Complete redesign of existing e-commerce platform with improved user experience and modern interface.",
  ...
  },
  {
    ...
    description: "Creative portfolio website showcasing work with smooth animations and modern design.",
  ...
  },
  {
    ...
    description: "Modern startup website with product showcase and investor information sections.",
  ...
  },
  {
    ...
    description: "Restaurant website with menu showcase and location information for local business.",
