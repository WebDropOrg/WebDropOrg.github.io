...
const webServices = [
  {
    ...
    description: "Reliable, fast hosting solutions with 99.9% uptime guarantee and global CDN.",
    features: ["99.9% Uptime", "Global CDN", "SSL Certificates", "Daily Backups"],
    interactive: true,
  ...
  },
  {
    ...
    features: ["Modern Design", "Mobile Optimization", "Speed Improvements", "SEO Enhancement"],
    interactive: true,
  ...
  },
  {
    ...
    description: "Build new features and functionality for your existing website.",
    features: ["New Features", "API Integration", "Database Setup", "Custom Forms"],
    interactive: true,
  ...
  },
  {
    ...
    features: ["Speed Optimization", "Core Web Vitals", "Image Compression", "Code Minification"],
    interactive: true,
  ...
  },
  {
    ...
    description: "Protect your website with security monitoring and automated backups.",
    features: ["Security Scanning", "Malware Protection", "Automated Backups", "SSL Management"],
    interactive: true,
...
const techStack = [
  ...
  { name: "Vercel", category: "Hosting", proficiency: 90, icon: "▲", description: "Frontend cloud platform", experience: "3+ years" },
  { name: "Netlify", category: "Hosting", proficiency: 85, icon: "🌐", description: "JAMstack hosting platform", experience: "3+ years" },
...
const developmentProcess = [
  {
    ...
    deliverables: ["Site Audit Report", "Improvement Recommendations", "Timeline", "Cost Estimate"]
  },
  {
    number: "02", 
    title: "Design & Setup",
    ...
    deliverables: ["Design Previews", "Hosting Account", "Development Access", "Asset Library"]
  },
  {
    number: "03",
...
const testimonials = [
  {
    ...
    content: "WebDrop helped us modernize our outdated website. The new design looks professional and loads much faster. Our customers love the improved experience.",
    rating: 4.8,
  ...
  },
  {
    ...
    content: "The hosting service is reliable and the support team is very responsive. They helped us migrate from our old host without any downtime.",
    rating: 4.7,
  ...
  },
  {
    ...
    content: "The maintenance service keeps our portfolio website running smoothly. Regular updates and monitoring give us peace of mind to focus on our clients.",
    rating: 4.9,
  ...
  },
  {
    ...
    content: "They redesigned our medical website with a focus on patient experience. The new appointment system is much easier for our patients to use.",
    rating: 4.6,
        ...
        <div className="container-custom relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={`text-lg text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed ${isVisible('hero') ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
              Fast, reliable website hosting, maintenance, and redesign services. 
              <span className="text-primary font-semibold"> We keep your website running smoothly</span> while you focus on your business.
            </p>
            ...
            <div className={`grid grid-cols-3 gap-8 max-w-2xl mx-auto ${isVisible('hero') ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
              {[
                { number: "47+", label: "Websites Maintained", icon: <Monitor className="w-6 h-6" /> },
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {Object.entries(selectedProject.metrics).map(([key, value], index) => (
                        <div key={index} className="text-center p-3 bg-background/50 rounded-lg hover:bg-primary/10 transition-all duration-300 cursor-default group">
      ...
      <section className="section-padding" data-animate id="services">
        <div className="container-custom">
          <div className={`text-center mb-16 ${isVisible('services') ? 'animate-slide-up' : 'opacity-0'}`}>
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Comprehensive website services to keep your online presence running smoothly.
            </p>
          </div>
      ...
      <section className="section-padding bg-secondary/20" data-animate id="testimonials">
        <div className="container-custom">
          <div className={`text-center mb-16 ${isVisible('testimonials') ? 'animate-slide-up' : 'opacity-0'}`}>
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Real feedback from clients who use our hosting, maintenance, and redesign services.
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-emerald-500/10 p-6 lg:p-8 flex flex-col justify-center">
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Ready to improve your website? We're here to help with hosting, maintenance, and redesign services.
                    </p>
                  </div>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto leading-relaxed">
              Professional website hosting, maintenance, and redesign services for growing businesses.
            </p>
            ...
            <div className="pt-6 border-t border-border">
              <p className="text-muted-foreground text-sm">
                ...
                <span className="text-primary ml-2">Built for businesses that want reliable websites.</span>
              </p>
            </div>
          </div>
        </div>
